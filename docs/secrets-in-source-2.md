...
Dev Tools from the browser menu open as expected. The page source in Dev Tools reveals a comment with a TODO note. The note gives a path to a file with a flag.
## Enumeration
